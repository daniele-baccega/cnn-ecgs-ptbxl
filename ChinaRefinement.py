...
parser.add_argument('--newpath', type=str, default="ChinaRefinement/D1/20Classes_0", help='Path to the directory in which to save the refined models (default: ChinaRefinement/D1/20Classes_0)')
