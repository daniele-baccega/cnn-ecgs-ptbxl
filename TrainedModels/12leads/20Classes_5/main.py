...
classes_dic, output_act_fun = get_classes_dic_and_output_activation_function(args.num_classes)
...
## Build the CNN
#  Generate the model
model                       = get_model(args.init_learning_rate,
                                        leads,
                                        args.num_classes,
...
history                     = model.fit(dataGenerator(args.num_classes,
                                        ...
                                        callbacks         = [lr_decay, checkpoint_val_accuracy, csv_logger, history_test_as_val],
                                        shuffle           = True,
                                        workers           = 1,
                                        verbose           = 1);
