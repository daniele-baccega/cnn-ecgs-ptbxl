...
## Build the model
def get_model(init_lr, leads, num_classes, time_length, optimizer, momentum, dropout, pool_sizes, dilation_factors, kernel_size_last_conv, output_act_fun):
   inputs               = Input(shape=(leads, time_length, 1,), dtype="float32", name="I1")
   x                    = Conv2D(1, (1, 1), name="C2")(inputs)
