'''
  ...
  GeorgiaRefinementLastLayer.py

  Fine-tuned the classification layer of the orignal network using the Georgia dataset train set.
...
parser.add_argument('--path', type=str, default="TrainedModels/D1/20Classes_0", help='Path to the directory in which to load the pre-trained model (default: TrainedModels/D1/20Classes_0)')
parser.add_argument('--newpath', type=str, default="GeorgiaRefinement/D1/20Classes_0", help='Path to the directory in which to save the fine-tuned models (default: GeorgiaRefinement/D1/20Classes_0)')
...
#  Transform the SNOMED labels in the diagnostic labels abbreviation
...
with open(args.newpath + '/y_pred_Georgia', 'wb') as y_pred_file:
  pickle.dump(y_pred, y_pred_file)

with open(args.newpath + '/y_test_Georgia', 'wb') as y_test_file:
